...
namespace StaffMasterAutomation
{
    public class LoginPage
    {
        public static void GoTo()
        {
            ...
            // wait for login text-box to appear
    ...
    public class LoginCommand
    {
        ...
        public LoginCommand WithPasword(string password)
        {
        ...
        public void Login()
        {
            ...
            var loginButton = Driver.Instance.FindElement(By.CssSelector(".btn"));
            loginButton.Click();

            var wait = new WebDriverWait(Driver.Instance, TimeSpan.FromSeconds(10));
            wait.Until(d => d.FindElement(By.CssSelector(".hipster")));
        }
    }
}
